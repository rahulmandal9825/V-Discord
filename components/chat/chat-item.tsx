                ...
                <div className="flex flex-col ">
                    ...
                    {isImage && (
                        <a
                            ...
                            className="relative aspect-square rounded-md mt-2 overflow-hidden border fle items-center bg-secondary h-48 w-48 "
                        >
                    ...
                    {!fileUrl && !isEditing && (
                        ...
                        >
                            {content}
                            {isUpdated && !deleted && (
                                <span className="text-[10px] mx-2 text-zinc-500 dark:text-zinc-200">(edited)</span>
                            )}
                        </p>
                    )}
                    {!fileUrl && isEditing && (
